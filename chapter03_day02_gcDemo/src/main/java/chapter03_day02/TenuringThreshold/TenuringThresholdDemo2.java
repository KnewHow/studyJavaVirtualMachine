 ...
 * sore it enough.
 * 
 * But not all objects need to reach max tenure threshold which can be moved to
 * old generation.If same tenure objects has take up more than half size of
 * Survivor,some objects whose tenure greater than those will be move to old
 * generation directed.
 * 
...
public class TenuringThresholdDemo2 {
	...
	public static void main(String[] args) {
		...
		/**
		 * make sure allocation1+allocation2 greater than
		 * Survivor size
		 */
